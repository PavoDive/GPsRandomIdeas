...
<td>
  ...
  <a   href="http://codecov.io/github/Rdatatable/data.table?branch=master">
  <img  src="http://codecov.io/github/Rdatatable/data.table/coverage.svg?branch=master"></a>

  <a   href="https://www.rdocumentation.org/trends">
  <img  src="http://cranlogs.r-pkg.org/badges/data.table"></a>

  <a   href="http://depsy.org/package/r/data.table">
  <img  src="http://depsy.org/api/package/cran/data.table/badge.svg"></a>
<br>
  Lin/Mac:
...
`data.table` es uno de los 13,000 paquetes de extensión para el lenguage de programación [R](https://www.r-project.org/about.html) que es muy popular en [estos campos](http://www.maths.lancs.ac.uk/~rowlings/R/TaskViews/). 
...
activa en Stack Overflow en relación con paquetes de R con más de [8,000 preguntas](http://stackoverflow.com/questions/tagged/data.table),
el [décimo más marcado como favorito](http://www.r-pkg.org/starred) paquete de R en GitHub y tenía más de 650 paquetes en CRAN y
...
&nbsp; &nbsp; &nbsp; `DT[...][...]`<br>
Consulta **data.table compared to dplyr (data.table comparado con dplyr)** en [Stack Overflow](http://stackoverflow.com/questions/21435339/data-table-vs-dplyr-can-one-do-something-well-the-other-cant-or-does-poorly) 
...
[![](https://github.com/Rdatatable/data.table/wiki/pictures/USTV.png)](http://blog.revolutionanalytics.com/2016/12/food-inspection-forecasting.html) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
[![](https://github.com/Rdatatable/data.table/wiki/pictures/origins.png)](http://datascience.la/matt-dowles-data-table-talk-from-user-2014/)<br>
...
* **lector de datos delimitados rápido y amigable**: [`?fread`](http://www.rdocumentation.org/packages/data.table/functions/fread). Acepta comandos de sistema directamente (tales como `grep` and `gunzip`), tiene otras [características convenientes para datos _pequeños_](https://github.com/Rdatatable/data.table/wiki/Convenience-features-of-fread) y está ahora **paralelizado** en CRAN Mayo 2018 y presentado antes [aquí](https://github.com/Rdatatable/data.table/wiki/talks/BARUG_201704_ParallelFread.pdf).
* **escritor de archivos rápido y paralelizado**: [`?fwrite`](http://www.rdocumentation.org/packages/data.table/functions/fwrite) anunciado [aquí](http://blog.h2o.ai/2016/04/fast-csv-writing-for-r/) y en CRAN en noviembre de 2016.
