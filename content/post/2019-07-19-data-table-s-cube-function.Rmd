...
First thing I notice is I needed to quote `Species`, second thing I noticed is I had to read the documentation *carefully*, as it states clearly _character column names by which we are grouping._
...
```{r}
cube(dt, j = .(mean(N), sum(N)), by = c("Sex", "Class"))
